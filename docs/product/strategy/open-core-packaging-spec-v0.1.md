...
| `packages/browser-explorer` | Open core target | Future browser exploration package |
| `packages/repair-planner` | Open core target | Future repair plan and task package package |
