...
export const acceptanceCompatibilityContract = {
  ...
  packageOwnedModules: ['compatibility', 'markdown', 'report', 'goal-audit', 'goal-audit-requirements', 'goal-audit-user-acceptance', 'goal-audit-user-acceptance-materials', 'goal-audit-sources', 'goal-audit-delivery', 'goal-audit-runtime', 'goal-audit-workflow-artifacts', 'goal-audit-observability-security', 'goal-audit-process-governance', 'goal-audit-evidence-documents', 'goal-audit-current-items', 'goal-audit-v03-distribution', 'goal-audit-public-release-readiness', 'user-acceptance', 'user-acceptance-handoff', 'fatal-error', 'redaction', 'repo-preflight', 'python-cli-profile', 'python-cli-checks', 'python-cli-artifacts', 'target-repo-feedback-summary', 'ai-ide-handoff-package', 'user-validation-evidence-loop', 'ai-ide-repair-playbook', 'ai-ide-playbook-consumption-report', 'ai-ide-repair-decision-package', 'ai-ide-repair-approval-receipt', 'ai-ide-approved-repair-execution-plan', 'ai-ide-repair-execution-evidence-report', 'ai-ide-repair-evidence-bundle-manifest', 'ai-ide-repair-evidence-consumer-contract', 'ai-ide-repair-execution-replay-readiness', 'ai-ide-target-repo-repair-goal-proposal-package', 'ai-ide-target-repo-repair-goal-authorization-receipt', 'ai-ide-authorized-target-repo-repair-goal-task-package', 'ai-ide-target-repo-repair-goal-execution-evidence-intake-report', 'ai-ide-target-repair-evidence-review-decision-package', 'blocked-goal-recovery-package', 'blocked-goal-recovery-lifecycle-campaign-summary', 'blocked-goal-recovery-consumption-report', 'blocked-goal-recovery-decision-receipt', 'blocked-goal-recovery-resume-attempt-task-package', 'blocked-goal-recovery-resume-attempt-closure-receipt', 'blocked-goal-recovery-resume-attempt-execution-evidence-intake', 'blocked-goal-recovery-resume-attempt-evidence-review-decision-package', 'campaign-summary', 'user-acceptance-args', 'run-acceptance', 'run-user-acceptance-handoff', 'run-repair-handoff', 'run-repair-execute', 'run-repair-patch-plan', 'run-project-intelligence-backlog', 'run-project-intelligence-controlled-remediation-plan', 'run-project-intelligence-watch', 'run-project-intelligence-decision-intake', 'run-project-intelligence-maintainer-decision', 'run-project-intelligence-recommendation-draft', 'run-project-intelligence-snapshot', 'run-project-intelligence-viewer', 'shell-quote', 'shell-words', 'user-acceptance-record', 'user-acceptance-runner-helpers', 'run-user-acceptance', 'run-goal-audit'],
  outputPaths: {
