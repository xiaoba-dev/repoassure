...
const refreshCommands = ['pnpm project:intelligence'] as const;
const watchedPrefixes = ['docs/', 'src/', 'packages/', 'apps/', 'tests/'] as const;
const watchedRootDirectories = ['docs', 'src', 'packages', 'apps', 'tests'] as const;
