...
const forbiddenClaims = [
  ...
  { id: 'artifacts-signed', pattern: '\\bartifacts are signed\\b' },
  { id: 'cryptographically-signed', pattern: '\\bcryptographically signed\\b' },
  { id: 'digitally-signed', pattern: '\\bdigitally signed\\b' },
  { id: 'signed-evidence', pattern: '\\bsigned\\s+(local\\s+)?evidence\\b' },
  { id: 'signed-artifacts', pattern: '\\bsigned\\s+artifacts?\\b' },
  { id: 'signed-bundle', pattern: '\\bsigned\\s+(artifact\\s+)?bundle\\b' },
  { id: 'zh-artifacts-signed', pattern: '(证据|物料|产出)[^。]{0,12}签名' },
  { id: 'zh-signed-evidence', pattern: '已签名的' },
