...
export const GOAL_AUDIT_TEXT_SOURCE_PATHS = {
  ...
  securityAssurancePackageJson: 'packages/security-assurance/package.json',
  ...
  securityAssuranceImporter: 'packages/security-assurance/src/import-security-evidence.ts',
  securityImportTool: 'src/tools/security-import-tool.ts',
  securityAssuranceTests: 'tests/unit/security-assurance.test.ts',
  securityAssuranceTypeSmoke: 'tests/type-smoke/security-assurance-package-subpaths.ts',
  securityLaneSpec: 'docs/architecture/specs/security-assurance-lane-spec-v0.1.md',
  githubActionWrapper: '.github/actions/repoassure/action.yml',
  githubActionExample: 'examples/github-actions/repoassure-local-first.yml',
  publicReleaseReadinessScript: 'scripts/check-public-release-readiness.mjs',
  publicReleaseReadinessTests: 'tests/unit/public-release-readiness.test.ts',
  publicReleaseReadinessAdr: 'docs/adr/0015-public-release-readiness-boundary.md',
  publicReleaseChecklist: 'docs/product/strategy/public-release-checklist-v0.1.md',
  license: 'LICENSE',
  contributing: 'CONTRIBUTING.md',
  securityPolicy: 'SECURITY.md',
  dependencyLicenseAudit: 'docs/product/strategy/dependency-license-audit-v0.1.md',
  publicReleaseNotes: 'docs/product/strategy/public-release-notes-v0.1.md',
  repairHandoffRunner: 'packages/acceptance/src/run-repair-handoff.ts',
  repairExecuteRunner: 'packages/acceptance/src/run-repair-execute.ts',
  repairPatchPlanRunner: 'packages/acceptance/src/run-repair-patch-plan.ts',
