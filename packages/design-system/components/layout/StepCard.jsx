...
export function StepCard({index,icon,title,children}){
  return <div style={{display:'grid',gap:14,padding:24,background:'var(--surface-default)',border:'1px solid var(--border-default)',borderRadius:'var(--radius-card)',fontFamily:'var(--font-sans)'}}>
