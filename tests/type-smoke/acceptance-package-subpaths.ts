...
import * as aiIdeRepairApprovalReceipt from '@hardening-mcp/acceptance/ai-ide-repair-approval-receipt';
...
import * as aiIdeRepairExecutionReplayReadiness from '@hardening-mcp/acceptance/ai-ide-repair-execution-replay-readiness';
import * as aiIdeTargetRepoRepairGoalProposalPackage from '@hardening-mcp/acceptance/ai-ide-target-repo-repair-goal-proposal-package';
import * as aiIdeTargetRepoRepairGoalAuthorizationReceipt from '@hardening-mcp/acceptance/ai-ide-target-repo-repair-goal-authorization-receipt';
...
import * as blockedGoalRecoveryResumeAttemptClosureReceipt from '@hardening-mcp/acceptance/blocked-goal-recovery-resume-attempt-closure-receipt';
...
import * as blockedGoalRecoveryResumeAttemptEvidenceReviewDecisionPackage from '@hardening-mcp/acceptance/blocked-goal-recovery-resume-attempt-evidence-review-decision-package';
...
const packageSubpathModules = [
  ...
  aiIdeRepairExecutionReplayReadiness,
